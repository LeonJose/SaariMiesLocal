...
namespace GestorReportes.PresentationLayer
{
    public partial class Frm_AuditoriaCobranza : Form
    {
        ...
        private List<ClienteEntity> listaAllClientes = new List<ClienteEntity>();
        ...
        {
           listaAllClientes = AuditoriaCobranza.obtenerClientes();
            cargarGrid();
        }
        ...
        private void cargarGrid()
        {
            ...
            gridClientes.DataSource = listaAllClientes;//AuditoriaCobranza.obtenerClientes();
        ...
        private void checkEmpresa_CheckedChanged(object sender, EventArgs e)
        {
            if (checkEmpresa.Checked)
            {
                ...
                comboEmpresa.DataSource = HelpInmobiliarias.obtenerInmobiliarias(usuario, permisosInmobiliaria); //AuditoriaCobranza.obtenerInmobiliarias();
        ...
        private void botonBuscar_ControlClicked(object sender, EventArgs e)
        {
            ...
            if (listaClientes != null)
            {
                ...
                {
                    listaClientes = listaAllClientes;//AuditoriaCobranza.obtenerClientes();
