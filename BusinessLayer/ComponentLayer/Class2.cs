...
{
    public class CarteraVencida3 : SaariReport, IReport, IBackgroundReport
    {
                ...
                if (File.Exists(rutaFormato))
                {
                    ...
                    if (listaRecibos != null)
                    {
                        if (listaRecibos.Count > 0)
                        {
                            ...
                            //List<Cartera306090Entity> lCart = new List<Cartera306090Entity>();
                            //lCart = (from l in listaCartera where (l.MonedaContrato != "P" && l.TotalPesos30 > 1) select l).ToList();
